    ...
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
      <div class="flex-none">
        ...
        <ul class="flex items-center mt-4">
          ...
          <li
            v-if="props.actorDetails?.social.instagram"
            class="ml-6"
          >
            <a
          ...
          <li
            v-if="props.actorDetails?.social.twitter"
            class="ml-6"
          >
            <a
              :href="props.actorDetails?.social.twitter"
              target="_blank"
              title="Twitter"
            >
              <svg
          ...
          >
            <a
              :href="props.actorDetails?.actor.homepage"
              target="_blank"
              title="Website"
            >
              <svg
      ...
      <div class="md:ml-8">
        ...
        <div class="flex flex-wrap items-center text-gray-400 text-sm">
          ...
          <span class="ml-2">
            {{ props.actorDetails?.actor.birthday }} ({{ props.actorDetails?.actor.age }}
            {{ t("actor.yearsOld") }}) {{ t("actor.in") }}
            {{ props.actorDetails?.actor.place_of_birth }}
          </span>
        </div>
        ...
        <h4 class="text-white font-semibold mt-6">
          {{ t("actor.knownFor") }}
        </h4>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 known-for-movies">
          <div
            ...
            class="mt-4"
          >
            <RouterLink :to="movie?.linkToPage">
              <img
                :src="movie.poster_path"
                alt="poster"
                class="hover:opacity-75 transition ease-in-out duration-150"
                style="max-width: 185px; max-height: 278px; width: 100%; height: 100%;"
              >
            </RouterLink>
            <RouterLink
              :to="movie.linkToPage"
