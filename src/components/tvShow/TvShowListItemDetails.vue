<template>
  <TvShowListItemDetailsInfo :tv-show-details="props.tvShowDetails" />
  <TvShowListItemDetailsCast :tv-show-details="props.tvShowDetails" />
  <TvShowListItemDetailsImages :tv-show-details="props.tvShowDetails" />
</template>
