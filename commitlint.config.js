  ...
  "questions": {
    "type": {
      "description": "Selecione o tipo de alteração que você está realizando:",
        ...
        "refactor": {
          "description": "Uma alteração de código que não corrige um bug nem adiciona uma funcionalidade",
        ...
        "ci": {
          "description": "Alterações em nossos arquivos e scripts de configuração de CI (exemplos de escopos: Travis, Circle, BrowserStack, SauceLabs)",
            "title": "Integrações Contínuas",
              "emoji": "⚙️"
        },
        "chore": {
          "description": "Outras alterações que não modificam arquivos de código-fonte ou de teste",
            "title": "Afazeres",
              "emoji": "♻️"
        },
        "revert": {
    ...
    "scope": {
      "description": "Qual é o escopo desta alteração (por exemplo, componente ou nome do arquivo)"
    },
    "subject": {
    ...
    "breakingBody": {
      "description": "Um commit com ALTERAÇÃO QUEBRA-COMPATIBILIDADE requer um corpo. Por favor, insira uma descrição mais longa do próprio commit"
    },
    "breaking": {
    ...
    "issuesBody": {
      "description": "Se problemas estiverem sendo fechados, o commit requer um corpo. Por favor, insira uma descrição mais longa do próprio commit"
    },
    "issues": {
      "description": "Adicione referências aos problemas relacionados (por exemplo, 'corrigir #123', 'rel #123')."
    }
  }
}
};
