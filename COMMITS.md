...
<table>
 ...
 <tbody>
    ...
    <tr>
      ...
      <td>📚 docs(README.md): Atualização do README</td>
    </tr>
    <tr>
      <td>
        <code>git commit -m ":bug: fix: Loop infinito na linha 50"</code>
      </td>
      <td>🐛 fix(main.ts): Loop infinito na linha 50</td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>🧱 ci(Dockerfile): Modificação no Dockerfile</td>
    </tr>
    <tr>
      <td>
        <code>git commit -m ":recycle: refactor: Passando para arrow functions"</code>
      </td>
      <td>♻️ refactor(helper/functions.ts): Passando para arrow functions</td>
    </tr>
    <tr>
      <td>
        <code>git commit -m ":zap: perf: Melhoria no tempo de resposta"</code>
      </td>
      <td>⚡ perf(orm/client.ts): Melhoria no tempo de resposta</td>
    </tr>
    <tr>
      <td>
...
Para saber mais detalhes de como contribuir com o projeto, favor, consultar o arquivo [CONTRIBUTING.md](CONTRIBUTING.md)
